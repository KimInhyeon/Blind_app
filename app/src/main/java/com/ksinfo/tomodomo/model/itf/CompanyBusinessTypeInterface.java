...
public interface CompanyBusinessTypeInterface {
    ...
    Call<CompanyBusinessTypeVO> getUserBusinessTypeCode(@Query("userId") Long userId);
    ...
    //Call<List<CompanyBusinessTypeVO>> getBusinessTypeListExistAIData( @Query("selectBusinessType") String selectBusinessType );
    @GET("company/annualIncome/getBusinessTypeListExistAIData")
